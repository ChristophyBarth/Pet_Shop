...
class SettingsFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        sharedPreferences = requireContext().getSharedPreferences(sharedPrefKey, Context.MODE_PRIVATE)
        ...
        if (sharedPreferences.contains("darkMode")) {
            ...
            if (darkMode) {
                ...
                binding.darkModeTextView.setTextColor(ContextCompat.getColor(requireContext(), R.color.white))
            } else {
                binding.root.setBackgroundColor(ContextCompat.getColor(requireContext(), R.color.white))
                binding.darkModeTextView.setTextColor(ContextCompat.getColor(requireContext(), R.color.black))
            }
        }
